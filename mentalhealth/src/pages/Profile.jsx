      ...
      if (auth.currentUser) {
        ...
        get(userRef).then(snapshot => {
          if (snapshot.exists()) {
            ...
            setPassword(data.password || ''); // Be careful with this
        ...
        <div className="profile-container landing-container">
          <div className="profile-content login-form">
            ...
            <div className="profile-info">
              ...
              <p><strong>Professional:</strong> {proffesional === 1 ? 'Yes' : 'No'}</p>
              <p><strong>Access:</strong> {access}</p>
              {/* Note: It's not recommended to display the password. If you need to, uncomment below. */}
