...
import './PendingApproval.css'; // You can create a CSS file for styling
...
function PendingApproval() {
    ...
    return (
        <div className="pending-approval-container text-center">
            ...
            <p>Your professional registration is <strong>pending approval</strong>. Once approved, you will be redirected to your home page. Thank you for your patience.</p>
        </div>
    );
}
